...
MOSQ_LIB_FILES	+= $(if $(BR2_PACKAGE_MOSQUITTO_BIN_LIBMOSQUITTOP),lib/cpp/libmosquittopp.so*,)
...
define MOSQUITTO_INSTALL_STAGING_CMDS
	...
	$(if $(BR2_PACKAGE_MOSQUITTO_HEADER_MOSQUITTOPP),install $(@D)/lib/cpp/mosquittopp.h $(STAGING_DIR)/usr/include)
endef
