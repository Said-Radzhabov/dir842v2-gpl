...
VALGRIND_SITE = $(DLINK_STORAGE)
VALGRIND_SOURCE = valgrind-$(VALGRIND_VERSION).tar.bz2
VALGRIND_LICENSE = GPL-2.0-only AND GFDL-1.2-or-later
...
VALGRIND_CONF_OPT += --includedir=/usr/include
...
VALGRIND_CFLAGS += -D__UCLIBC__
define VALGRIND_INSTALL_UCLIBC_SUPP
	cat package/valgrind/uclibc.supp >> $(TARGET_DIR)/usr/lib/valgrind/default.supp
endef
endif
ifeq ($(BR2_TOOLCHAIN_USES_MUSL),y)
VALGRIND_CFLAGS += -DMUSL_LIBC
endif
