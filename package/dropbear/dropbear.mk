...
DROPBEAR_CONF_OPT = --disable-harden
...
DROPBEAR_CONF_OPT += --disable-static
endif
...
define DROPBEAR_INSTALL_PAM_CONF
	$(INSTALL) -D -m 644 package/dropbear/etc-pam.d-sshd $(LINUX_PAM_CONFIGS_DIR)/sshd
endef
...
DROPBEAR_CONF_OPT += --disable-zlib --enable-bundled-libtom
else
...
DROPBEAR_CONF_OPT += --disable-bundled-libtom
endif
...
ifeq ($(BR2_DSYSINIT),y)
DROPBEAR_DEPENDENCIES += deuteron_framework
DROPBEAR_CONF_ENV = LIBS="-ld_service_notify -ljansson -Wl,-rpath-link,$(STAGING_DIR)/lib -Wl,-rpath-link,$(STAGING_DIR)/usr/lib"
endif
