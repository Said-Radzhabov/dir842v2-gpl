...
LUA_MYLIBS += -ldl
HOST_LUA_CFLAGS += -DLUA_USE_DLOPEN
HOST_LUA_MYLIBS += -ldl
...
define HOST_LUA_PACKAGE_PATH_FIX
	$(SED) 's:#define LUA_ROOT	"/usr/":#define LUA_ROOT	"$(HOST_DIR)/usr/":' $(@D)/src/luaconf.h
	$(SED) 's/\/\* #define LUAC_CROSS_SUPPORT \*\//#define LUAC_CROSS_SUPPORT/' $(@D)/src/luaconf.h
endef
HOST_LUA_POST_PATCH_HOOKS += HOST_LUA_PACKAGE_PATH_FIX
...
LUA_POST_INSTALL_TARGET_HOOKS += LUA_CLEANUP
