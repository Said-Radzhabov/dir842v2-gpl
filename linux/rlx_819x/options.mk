...
# multi ap (easy mesh)
define KERNEL_RTK_MULTI_AP
@$(call MESSAGE,"Enable RTK_MULTI_AP")
@$(call KCONFIG_ENABLE_OPT,CONFIG_RTK_MULTI_AP, $(LINUX_CONFIG));
@$(call KCONFIG_ENABLE_OPT,CONFIG_RTK_MULTI_AP_R1_DFS, $(LINUX_CONFIG));
@$(call KCONFIG_ENABLE_OPT,CONFIG_BRIDGE_NF_EBTABLES, $(LINUX_CONFIG));
@$(call KCONFIG_ENABLE_OPT,CONFIG_BRIDGE_EBT_T_FILTER, $(LINUX_CONFIG));
endef

ifeq ($(BR2_PACKAGE_RTK_MULTI_AP),y)
LINUX_ADDONS += KERNEL_RTK_MULTI_AP
endif
