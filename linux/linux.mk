...
LINUX26_MAKE_FLAGS += BUILD_HND_MFG=y BUILD_BCM_WLAN_NO_MFGBIN=y
...
else ifeq ($(BR2_RTL8192CD_VER_406P1),y)
	@ln -snf rtl8192cd_406p1 $(LINUX26_DIR)/drivers/net/wireless/rtl8192cd
endif # BR2_RTL8192CD_VER_XXX
endif # RLX_86XX
endif # BR2_rlx

ifeq ($(RTL8198D),y)
	@ln -snf dts/$(BR2_DLINK_GENERIC_PROFILE).dts $(LINUX26_DIR)/vendors/rtl8198d_engboard.dts
endif # RTL8198D
...
LINUX26_DEPENDENCIES += host-kmod toolchain
...
kernel-configure: toolchain $(LINUX26_DIR)/.stamp_configured
...
kernel-build: toolchain $(LINUX26_DIR)/.stamp_compiled
