...
ROOTFS_DEVICE_TABLES = $(call qstrip,$(BR2_ROOTFS_DEVICE_TABLE) $(BR2_ROOTFS_STATIC_DEVICE_TABLE))
ROOTFS_COMMON_DEPENDENCIES = host-fakeroot host-makedevs host-gpp
...
$(eval ROOTFS_$(2)_DEPENDENCIES += rootfs-common)
...
TARGETS += $$(filter-out rootfs-%,$$(ROOTFS_$(2)_FINAL_RECURSIVE_DEPENDENCIES))
endif
endef
